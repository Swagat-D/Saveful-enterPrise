...
export const getAdminSidebarLinks = (): SidebarLink[] => {
  ...
  return [
    ...
    { label: "Enterprise users", href: `/admin/users${query}`, icon: <Users className={iconClass} /> },
    { label: "App users", href: `/admin/app-users${query}`, icon: <Smartphone className={iconClass} /> },
